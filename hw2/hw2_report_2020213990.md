...
Use Visdom to visualize training and test curves. Model C (DilateNet18[0,0,1,1]) achieves **75.73%** accuracy on the **large-scale training** set and **95.98%** accuracy on the **test** set. The training and test curves are as follows:
