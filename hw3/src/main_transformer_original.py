        ...
        if batch % log_interval == 0 and batch > 0:
            ...
            print('| epoch {:3d} | {:5d}/{:5d} batches | '
                  ...
                  'loss {:5.2f} | ppl {:8.2f}'.format(epoch, batch, len(data_loader.train_data) // args.bptt,
                                                      optimizer.param_groups[0]['lr'], elapsed * 1000 / log_interval,
...
if __name__ == "__main__":
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if args.model == 'Transformer':
            viz_title = args.model + str(args.nlayers) + str(args.nhead) + '_original_loss'
            model_name = args.model + str(args.nlayers) + str(args.nhead) + '_original_best_model.pt'
        else:
